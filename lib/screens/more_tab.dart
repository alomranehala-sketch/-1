              ...
              children: [
                  ...
                  _MenuItem(
                    ...
                    () => _push(
                      ...
                      const Directionality(
                        ...
                        child: Scaffold(body: MedicalRecordTab()),
                      ),
                    ),
                  ),
                  _MenuItem(
                ...
                _buildMenuSection(context, 'الرعاية الشخصية', [
                  _MenuItem(
                    ...
                    'التبرع بالدم',
                    'جديد',
                    () => _push(context, const BloodDonationScreen()),
                  ),
                  _MenuItem(
                ...
                const SizedBox(height: 12),
                _buildMenuSection(context, 'البوابة الصحية الموحدة 🏥', [
                  _MenuItem(
                    Icons.qr_code_scanner_rounded,
                    'جواز الصحة الموحد',
                    'جديد',
                    () => _push(context, const HealthPassportScreen()),
                  ),
                  _MenuItem(
                    Icons.calendar_month_rounded,
                    'حجز ذكي موحد',
                    'جديد',
                    () => _push(context, const SmartBookingScreen()),
                  ),
                  _MenuItem(
                    Icons.psychology_rounded,
                    'فرز ذكي AI Triage',
                    'AI',
                    () => _push(context, const AiTriageScreen()),
                  ),
                  _MenuItem(
                    Icons.timer_rounded,
                    'دور مباشر — Live Queue',
                    'مباشر',
                    () => _push(context, const LiveQueueScreen()),
                  ),
                  _MenuItem(
                    Icons.swap_horiz_rounded,
                    'تحويل رقمي',
                    null,
                    () => _push(context, const DigitalReferralScreen()),
                  ),
                  _MenuItem(
                    Icons.videocam_rounded,
                    'تليميديسين',
                    null,
                    () => _push(context, const TelemedicineScreen()),
                  ),
                  _MenuItem(
                    Icons.calculate_rounded,
                    'حاسبة التأمين',
                    'جديد',
                    () => _push(context, const InsuranceCalculatorScreen()),
                  ),
                  _MenuItem(
                    Icons.local_pharmacy_rounded,
                    'مخزون الصيدليات',
                    null,
                    () => _push(context, const PharmacyStockScreen()),
                  ),
                  _MenuItem(
                    Icons.dashboard_rounded,
                    'موارد المستشفيات',
                    'مباشر',
                    () => _push(context, const HospitalResourcesScreen()),
                  ),
                ]),
                const SizedBox(height: 12),
                _buildMenuSection(context, 'ذكاء اصطناعي وتحليلات 🤖', [
                  _MenuItem(
                    Icons.health_and_safety_rounded,
                    'مدرب الصحة AI',
                    'AI',
                    () => _push(context, const AiHealthCoachScreen()),
                  ),
                  _MenuItem(
                    Icons.image_search_rounded,
                    'تحليل الصور والأعراض',
                    'AI',
                    () => _push(context, const SymptomAnalyzerScreen()),
                  ),
                  _MenuItem(
                    Icons.record_voice_over_rounded,
                    'تقييمات وتجارب المرضى',
                    null,
                    () => _push(context, const VoiceReviewsScreen()),
                  ),
                  _MenuItem(
                    Icons.school_rounded,
                    'صحة المدارس',
                    'جديد',
                    () => _push(context, const SchoolHealthScreen()),
                  ),
                  _MenuItem(
                    Icons.analytics_rounded,
                    'لوحة الأردن الصحية',
                    null,
                    () => _push(context, const NationalDashboardScreen()),
                  ),
                  _MenuItem(
                    Icons.business_rounded,
                    'لوحة عمليات المستشفى',
                    null,
                    () => _push(context, const HospitalOperationsScreen()),
                  ),
                ]),
                const SizedBox(height: 12),
              ...
              return Material(
                ...
                child: InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        Icon(item.icon, color: AppColors.textDark, size: 20),
